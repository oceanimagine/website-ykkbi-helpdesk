...
class get_hduserlevel extends CI_Model {
    ...
    function get_data(){
        ...
        $sql = "select kode_level, nama_level from hduserlevel".$clouse." order by kode_level asc limit $iDisplayStart , $iDisplayLength";

        $page = ($iDisplayStart / $iDisplayLength);

        $resuld = $process_table->coba_db($sql, $page, $iDisplayLength, true, "../../../index.php/hduserlevel/edit", "../../../index.php/hduserlevel/hapus");
