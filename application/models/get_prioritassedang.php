...
class get_prioritassedang extends CI_Model {
    ...
    function get_data(){
        ...
        $clouse = " where b.prioritas = 'sedang'";
        ...
        $resuld = $process_table->coba_db($sql, $page, $iDisplayLength, true, "../../../index.php/prioritassedang/edit", "../../../index.php/prioritassedang/hapus");
