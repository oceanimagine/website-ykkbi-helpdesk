...
class get_prioritasrendah extends CI_Model {
    ...
    function get_data(){
        ...
        $resuld = $process_table->coba_db($sql, $page, $iDisplayLength, true, "../../../index.php/prioritasrendah/edit", "../../../index.php/prioritasrendah/hapus");
