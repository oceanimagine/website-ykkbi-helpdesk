...
class prioritassedang extends CI_Controller {
    
    public $layout;
    
    public function __construct() {
        parent::__construct();
        $this->load->model('get_prioritassedang');
        $this->layout = new layout('lite');
        Privilege::admin();
    }

    public function get_prioritassedang() {
        $this->get_prioritassedang->get_data();
    }

    public function script_table(){
        return $this->layout->loadjs("prioritassedang/get_prioritassedang");
    }
    
    public function hapus($id){
        $_GET['id'] = $id;
        
        $this->get_prioritassedang->process(array(
            'action' => 'delete',
            'table' => 'hdcasedaftar',
            'where' => 'notiket = \''.$id.'\''
        ));
        redirect('prioritassedang');
    }
    ...
    public function edit($id){
        if($this->input->post('notiket')){
            ...
            redirect('prioritassedang/edit/'.$id.'');
        }
        ...
        $this->layout->loadView('prioritassedang_form', array(
