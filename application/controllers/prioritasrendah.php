...
class prioritasrendah extends CI_Controller {
    
    public $layout;
    
    public function __construct() {
        parent::__construct();
        $this->load->model('get_prioritasrendah');
        $this->layout = new layout('lite');
        Privilege::admin();
    }

    public function get_prioritasrendah() {
        $this->get_prioritasrendah->get_data();
    }

    public function script_table(){
        return $this->layout->loadjs("prioritasrendah/get_prioritasrendah");
    }
    
    public function hapus($id){
        $_GET['id'] = $id;
        
        $this->get_prioritasrendah->process(array(
            'action' => 'delete',
            'table' => 'hdcasedaftar',
            'where' => 'notiket = \''.$id.'\''
        ));
        redirect('prioritasrendah');
    }
    ...
    public function edit($id){
        if($this->input->post('notiket')){
            ...
            redirect('prioritasrendah/edit/'.$id.'');
        }
        ...
        $this->layout->loadView('prioritasrendah_form', array(
