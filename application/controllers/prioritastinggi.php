...
class prioritastinggi extends CI_Controller {
    
    public $layout;
    
    public function __construct() {
        parent::__construct();
        $this->load->model('get_prioritastinggi');
        $this->layout = new layout('lite');
        Privilege::admin();
    }

    public function get_prioritastinggi() {
        $this->get_prioritastinggi->get_data();
    }

    public function script_table(){
        return $this->layout->loadjs("prioritastinggi/get_prioritastinggi");
    }
    
    public function hapus($id){
        $_GET['id'] = $id;
        
        $this->get_prioritastinggi->process(array(
            'action' => 'delete',
            'table' => 'hdcasedaftar',
            'where' => 'notiket = \''.$id.'\''
        ));
        redirect('prioritastinggi');
    }
    ...
    public function edit($id){
        if($this->input->post('notiket')){
            ...
            redirect('prioritastinggi/edit/'.$id.'');
        }
        ...
        $this->layout->loadView('prioritastinggi_form', array(
