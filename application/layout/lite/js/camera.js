...
function call() {
    ...
    var servers = {iceServers: [{ url: 'stun:192.168.1.170' }]};
    var server2 = {iceServers: [{ url: 'stun:192.168.1.170' }]};
    ...
    remotePeerConnection =
            new webkitRTCPeerConnection(server2);  // eslint-disable-line new-cap
