...
(function (e) {
    ...
    var Webcam = {version: "1.0.8", protocol: location.protocol.match(/https/i) ? "https" : "http", loaded: false, live: false, userMedia: true, params: {width: 0, height: 0, dest_width: 0, dest_height: 0, image_format: "jpeg", jpeg_quality: 90, force_flash: false, flip_horiz: false, fps: 30, upload_name: "webcam", constraints: null, swfURL: "", flashNotDetectedText: "ERROR: No Adobe Flash Player detected.  Webcam.js relies on Flash for browsers that do not support getUserMedia (like yours)."}, errors: {FlashError: a, WebcamError: s}, hooks: {}, init: function () {
            ...
            var t = "Shockwave Flash", a = "ShockwaveFlash.ShockwaveFlash", s = "application/x-shockwave-flash", i = e, r = navigator, o = false;
            ...
            if (!e)
                return this.dispatch("error", new s("Please provide a callback function or canvas to snap()"));
            if (this.preview_active) {
            ...
            var a = e.replace(/[^A-Za-z0-9\+\/]/g, ""), s = a.length, i = t ? Math.ceil((s * 3 + 1 >> 2) / t) * t : s * 3 + 1 >> 2, r = new Uint8Array(i);
            ...
            o.onload = function () {
                if (a)
                    a.apply(h, [o.status, o.responseText, o.statusText]);
